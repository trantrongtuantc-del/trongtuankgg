...
def calc_lenh_cuoi(df: pd.DataFrame, config: dict) -> dict:
    ...
    lc_c1_bull = 1 if (ichi_buy and vwap_bull and ob_bull and fvg_bull and momentum_up and vol_spike and bull_trend) else 0
    lc_c2_bull = 1 if mbuy >= p_masterMin(config) else 0
    ...
    lc_c7_bull = 1 if vwap_bull else 0
