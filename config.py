...
# Tự động load .env nếu có (ưu tiên biến môi trường của Railway)
try:
    from dotenv import load_dotenv
    load_dotenv(override=False)  # override=False: Railway env > .env file
...
# ── Signal thresholds ─────────────────────────────────────
MIN_BUY_SCORE    = int(os.getenv("MIN_BUY_SCORE",  "5"))
MIN_SELL_SCORE   = int(os.getenv("MIN_SELL_SCORE", "5"))
MIN_MASTER_SCORE = int(os.getenv("MIN_MASTER_SCORE", "6"))
...
# ── Misc ─────────────────────────────────────────────────
CANDLES_NEEDED       = 300
MAX_SIGNALS_PER_SCAN = int(os.getenv("MAX_SIGNALS_PER_SCAN", "20"))
