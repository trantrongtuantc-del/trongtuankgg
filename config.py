...
# Ngưỡng xác nhận Trend Start (1-5)
MIN_MASTER_SCORE = int(os.getenv("MIN_CONF", "2"))     # ← min xác nhận để phát tín hiệu
...
RR_RATIO     = float(os.getenv("RR_RATIO", "2.5"))   # Trend Start RR
SWING_LOOKBACK = int(os.getenv("SWING_LOOKBACK", "10"))  # swing len cho SL
